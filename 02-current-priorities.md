...
- License enforcement — ✓ implemented and committed across **v1.17.4** (`c0bb75e`), **v1.17.5** (`a63bb86`), **v1.17.6** (`41502fb`); launch onboarding/support UX polish in **v1.17.7 — AI Onboarding and Support Offer UX** (`4914322`). Plugin-side work is complete. Per owner confirmation (2026-07-01), WRN Hub product record, WooCommerce Annual BYOK product, and the live license/update/download flow have also been created and tested — remaining items are reconfirming the Hub-seeded version matches 1.17.7 and confirming price points/plan objects (see `06-products/wrn-store-monitor.md` Pre-Release Blockers).
